define(['jquery',
    ...
    function($, Backbone, VendorCardView) {
        ...
        var data = { name : "name999", systemNumber: "4564567456",  contactDetails: "Вкладка карточка состоит из 2 частей: Карточка на просмотр и карточка на редактирование. Данная вкладка доступна на редактирование всегда всем сотрудникам группы «Поставщики» независимо от запущенных"
        };
